...
R1 = Resistor(1*80); % create an 80Ohm resistor
CapVal = 0.005; % 3.5e-5; % the capacitance value in Farads
L1 = Inductor(1/2*CapVal*Fs); % create the capacitance
s1 =  Series(V1,Parallel(L1,R1)); % create WDF tree as a ser. conn. of V1,C1, and R1
